---
{"dg-publish":true,"dg-path":"数学/数理统计/上分位点.md","permalink":"/数学/数理统计/上分位点/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-05-31T14:19:01.682+08:00","updated":"2024-06-08T14:59:23.264+08:00"}
---

**Upper Quantile**
对于给定的[[概率\|概率]] $\alpha \in(0,1)$，[[随机变量\|随机变量]] $X$
满足 $P\left\{X>x_{\alpha} \right\}$ 的实数指标 $x_{\alpha}$ 为 $X$ 的概率分布的上分位数
