---
{"tags":["State","Control","System","Linear"],"aliases":["状态","状态空间方程"],"dg-publish":true,"dg-path":"自动控制原理/状态空间.md","Level":1,"permalink":"/自动控制原理/状态空间/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-09-04T12:29:34.093+08:00","updated":"2024-10-01T13:46:54.827+08:00"}
---

(terminology::**State Space**)   系统的内部描述方法
...
### 状态空间表达式
[[状态空间表达式\|状态空间表达式]]通常由两个方程表示 (对于线性系统)
- **==状态方程==**
	一阶向量线性**微分方程或差分方程**的形式
	表征输入变量和内部变量的因果关系
- **==输出方程==**
	**向量代数方程**的形式
