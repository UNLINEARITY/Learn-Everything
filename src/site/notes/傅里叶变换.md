---
{"dg-publish":true,"dg-path":"数学/复变函数/傅里叶变换.md","tags":["Transform"],"permalink":"/数学/复变函数/傅里叶变换/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-05-21T17:23:34.830+08:00","updated":"2024-08-14T15:06:30.321+08:00"}
---

**FT**  (terminology::**Fourier Fransform** )
> 信号处理的本质
...
### 广义傅里叶变换
[[傅里叶级数\|傅里叶级数]]和傅里叶变换以不同形式反映了周期函数和非周期函数的频谱特性
